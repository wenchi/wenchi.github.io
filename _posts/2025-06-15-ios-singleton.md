...
## Singleton
Singleton 原則是單例對象必須保證只有一個實例存在。不管是以何種方式實現，這個設計模式在軟體開發常見。甚至有些內建的類別已經是單例。iOS 有幾種作法可以讓開發者自己做出符合單例的類別，特別要注意 Thread Safety 即可。如果使用 Swift 開發，有官方推薦的做法。
...
- 更 Swifty 的單例
    ...
    我們會發現沒有使用 dispatch_once，因為在 <a href="https://developer.apple.com/swift/blog/?id=7" target="_blank" rel="noopener noreferrer">Swift blog</a> 有這一段話可以讓我們不用自己寫 dispatch_once。
...
- 官方推薦的 Swift 寫法
    ...
    在 <a href="https://developer.apple.com/documentation/swift/cocoa_design_patterns#//apple_ref/doc/uid/TP40014216-CH7-ID177" target="_blank" rel="noopener noreferrer">Cocoa Design Patterns</a> 介紹常見的模式裡，<a href="https://developer.apple.com/documentation/swift/cocoa_design_patterns/managing_a_shared_resource_using_a_singleton" target="_blank" rel="noopener noreferrer">Managing a Shared Resource Using a Singleton</a> 非常清楚的告知開發者，只要這樣寫即可。
